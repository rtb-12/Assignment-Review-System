...
urlpatterns = [
    ...
    path('assignments/<int:assignment_id>/',
         ViewAssignmentDetailsView.as_view(), name='view-assignment-details'),
    path('api/assignments/add-member-to-assignment/', AddMembersToAssignmentView.as_view(),
         name='add-member-to-assignment'),
    path('api/assignments/add-group-to-assignment/', AddGroupToAssignment.as_view(),
         name='add-group-to-assignment'),
